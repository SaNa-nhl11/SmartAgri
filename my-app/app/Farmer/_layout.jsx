              ...
              <Animated.View style={[styles.sidebarContent, {transform: [{ translateX: slideAnim }]}]}>
                ...
                <View style={styles.sidebarItems}>
                  ...
                  {isHomeExpanded && (
                    <View style={styles.submenu}>
                      <Pressable 
                        ...
                        onPress={() => handleNavigation('/Farmer/PlantHealth')}
                      >
                      ...
                      <Pressable 
                        style={styles.submenuItem}
                        onPress={() => handleNavigation('/Farmer/Greenhouses')}
                      >
                      ...
                      <Pressable 
                        style={styles.submenuItem}
                        onPress={() => handleNavigation('/Farmer/AIRecommendations')}
                      >
                  ...
                  <Pressable 
                    ...
                    onPress={() => handleNavigation('/Farmer/Account')}
                  >
